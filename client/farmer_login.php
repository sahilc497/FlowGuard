...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (!empty($username) && !empty($password)) {
    // MySQL mysqli syntax
    $stmt = $conn->prepare("SELECT * FROM farmers WHERE username = ? LIMIT 1");
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 900px) {
      ...
      .brand-panel { display: none; } /* Hide brand panel on mobile for cleaner login focus */
...
<body>
  ...
  <div class="brand-panel">
    ...
    <div class="brand-content">
      ...
      <p class="brand-subtitle">Smart Water Management System</p>
    </div>
  </div>
  ...
  <div class="login-panel">
    ...
    <div class="login-wrapper">
      <div class="login-header">
        <h2>Farmer Login</h2>
        <p>Access your dashboard to monitor irrigation</p>
      </div>
      ...
      <div class="footer-links">
        <p>Don't have an account? <a href="farmer_register.php">Create Account</a></p>
      </div>
    </div>
  </div>
